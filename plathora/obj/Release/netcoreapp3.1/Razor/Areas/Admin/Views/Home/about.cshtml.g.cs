#pragma checksum "E:\yogita 6.8.19\asp.net core\Final backup 4.9.20\plathoraNewDomain\plathora final\plathora\Areas\Admin\Views\Home\about.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "354a92bc7dd3debf55e2ba9ea559ed0a384edfd4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"354a92bc7dd3debf55e2ba9ea559ed0a384edfd4", @"/Areas/Admin/Views/Home/about.cshtml")]
...
<section class=""sptb"">
    <div class=""container"">
        ...
        <div class=""row "">
            ...
            <div class=""col-md-6 col-lg-4 features"">
                <div class=""card"">
                    <div class=""card-body text-center"">
                        <div class=""feature"">
                            <div class=""cat-img category-svg d-block mt-3 mb-5"">
                                <i class=""fa fa-heart fs-30 text-primary icon-lineheight""></i>
                    ");
            WriteLiteral(@"        </div>
            ...
            <div class=""col-md-6 col-lg-4 features"">
                <div class=""card"">
                    <div class=""card-body text-center"">
                        <div class=""feature"">
                            <div class=""cat-img category-svg d-block mt-3 mb-5"">
                                <i class=""fa fa-bookmark fs-30 text-primary icon-lineheight""></i>
                            </div>
            ...
            <div class=""c");
            WriteLiteral(@"ol-md-6 col-lg-4 features"">
                <div class=""card mb-lg-0"">
                    <div class=""card-body text-center"">
                        <div class=""feature"">
                            <div class=""cat-img category-svg d-block mt-3 mb-5"">
                                <i class=""fa fa-line-chart fs-30 text-primary icon-lineheight""></i>
                            </div>
                ...
                <div class=""card mb-lg-0 mb-md-0"">
                    <div class=""card-body text-center"">
                        <div class=""feature"">
                            <div class=""cat-img category-svg d-block mt-3 mb-5"">
                                <i class=""fa fa");
            WriteLiteral(@"-handshake-o fs-30 text-primary icon-lineheight""></i>
                            </div>
                            <h3>User Friendly</h3>
                            <p>our being able to do what we like best, every pleasure is to be welcomed and every pain.</p>
                        </div>
            ...
            <div class=""col-md-6 col-lg-4 features"">
                <div class=""card mb-0 overflow-hidden"">
                    <div class=""card-body text-center"">
                        <div class=""feature"">
                            <div class=""cat-img category-svg d-block mt-3 mb-5"">
                                <i class=""fa fa-phone fs-30 text-primary icon-lineheight""></i>
                            </div>
                            <h3>24/7 Support</h3>
                            <p>our being able to do what we like best, every pleasure is to be welcomed and every pain.</p>
                        </div>
                ...
                <div class=""row text-center"">
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <div class=""counter-status status-1 md-lg-0"">
                         ");
            WriteLiteral(@"   <div class=""counter-icon text-warning"">
...
<section class=""sptb bg-white"">
    <div class=""container"">
        ...
        <div class=""row"">
                ...
                <div class=""card mb-lg-0"">
                    <div class=""card-body"">
                        <div class=""team-section text-center"">
                            <div class=""team-img"">
                                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "354a92bc7dd3debf55e2ba9ea559ed0a384edfd431796", async() => {
            }
            );
            ...
            <div c");
            WriteLiteral(@"lass=""col-lg-4 col-md-12"">
                <div class=""card mb-lg-0"">
                    <div class=""card-body"">
                        <div class=""team-section text-center"">
                            <div class=""team-img"">
                                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "354a92bc7dd3debf55e2ba9ea559ed0a384edfd434340", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
            ...
            WriteLiteral(@"
                            ...
                            <h6 class=""font-weight-semibold mb-4 mt-2"">Web Designer</h6>
                            <p class=""font-weight-normal dark-grey-text"">
                                Lorem ipsum dolor sit amet, quis nostrum exercitationem ullam quis nostrum  corporis suscipit laboriosam, nisi ut aliquid commodi.
                            </p>
                            <div class=""text-warning"">
                                <i class=""fa fa-star""> </i>
                                <i class=""fa fa-star""> </i>
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "354a92bc7dd3debf55e2ba9ea559ed0a384edfd436882", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
